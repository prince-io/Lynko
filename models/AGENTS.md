...
- `isDeleted` (Boolean, default false) — soft-delete flag; set on user request, doc kept during grace period for cancellation
- `deletionScheduledAt` (Date, default null) — timestamp when user confirmed deletion; cron uses this to determine if grace period has elapsed
- timestamps: true
