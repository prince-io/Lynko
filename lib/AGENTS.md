...
- Exports: `THEMES` (35 DaisyUI theme names), `FONT` (10 font objects), `SIZE` (6 scale levels), `RADIUS` (6 values), `BORDER` (4 style objects), `AVATAR` (7 shapes), `BG` (9 background options), `BTN` (4 button styles), `BTNRAD` (2 button shapes)
